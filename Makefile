BUILD = build
MAKEFILE = Makefile
OUTPUT_FILENAME = Transhimalaja_Sven_Hedin_Zweiter_Band
TITLE_NAME = "Transhimalaja. Zweiter Band."
...
PREFACE_EPUB = chapters/preface/preface_epub.md chapters/preface/00_Abbildungen_epub.md
PREFACE_HTML_PDF = chapters/preface/preface_epub.md chapters/preface/00_Abbildungen_pdf_html.md
...
$(BUILD)/pdf/$(OUTPUT_FILENAME).pdf: $(MAKEFILE) $(METADATA) $(CHAPTERS) $(CSS_FILE) $(IMAGES) $(COVER_IMAGE) $(METADATA_PDF) $(PREFACE_EPUB)
	mkdir -p $(BUILD)/pdf
	cp  *.css  $(IMAGES_FOLDER)
	cp  $(IMAGES_FOLDER)/Transhimalaja_Band_II_*.jpg .
